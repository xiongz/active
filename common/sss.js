!function () {
    ...
    location.href.indexOf("dev.web") < 0 ? angular.module("exceptionOverride", []).factory("$exceptionHandler", [function () {
    ...
    }]) : angular.module("exceptionOverride", []), angular.module("Controllers").controller("appController", ["$rootScope", "$scope", "$timeout", "$log", "$state", "$window", "ngDialog", "mmpop", "appFactory", "loginFactory", "contactFactory", "accountFactory", "chatFactory", "confFactory", "contextMenuFactory", "notificationFactory", "utilFactory", "reportService", "actionTrack", "surviveCheckService", "subscribeMsgService", "stateManageService", function (e, t, o, n, r, a, i, c, s, l, u, f, d, g, m, p, h, M, y, C, v, w) {
        function S() {
            return u.pickContacts(["friend", "chatroom"], {
                chatroom: {keyword: t.keyword, isNewArray: !0},
                friend: {keyword: t.keyword, isNewArray: !0, isWithoutBrand: !0, showFriendHeader: !0}
            }, !0).result
        }
        ...
        function T() {
            t.isLoaded = !0, t.isUnLogin = !1, M.report(M.ReportType.timing, {timing: {initStart: Date.now()}}), s.init().then(function (n) {
                ...
                f.setUserInfo(n.User), f.setSkey(n.SKey), f.setSyncKey(n.SyncKey), u.addContact(n.User), u.addContacts(n.ContactList), d.initChatList(n.ChatSet), d.notifyMobile(f.getUserName(), g.StatusNotifyCode_INITED), v.init(n.MPSubscribeMsgList), e.$broadcast("root:pageInit:success"), h.setCheckUrl(f), h.log("getUserInfo", f.getUserInfo()), t.$broadcast("updateUser"), M.report(M.ReportType.timing, {timing: {initEnd: Date.now()}});
        ...
        function N(e) {
            ...
            try {
                f.setSyncKey(e.SyncKey), f.updateUserInfo(e.Profile, function () {
                ...
                t.other = {reason: "throw err when syncChackHasChange"}, window._errorHandler && window._errorHandler(t)
            } finally {
                E()
            }
        }
                ...
                return t.keyword ? (I && I.close(), void(I = c.open({
                    ...
                    controller: ["$rootScope", "$scope", "$state", function (e, t, o) {
                        t.$watch(function () {
                            ...
                            n.UserName && (o.go("chat", {userName: n.UserName}), t.closeThisMmPop(), e.$broadcast("root:searchList:cleanKeyWord"))
                        }
                    }],
                    scope: {
                        keyword: t.keyword, allContacts: S(), heightCalc: function (e) {
        ...
        t.$on("ngDialog.opened", function (e, t) {
            ...
            if (t.account) {
                var o = t.account, n = e.pageY + 25, a = e.pageX + 6;
                c.open({
                    ...
                    controller: ["$scope", function (e) {
                        e.contact = o, e.addUserContent = "", e.isShowSendBox = !1, e.chat = function (t) {
                            r.go("chat", {userName: t}), e.closeThisMmPop()
                        }
                    }]
                })
            }
    ...
    "use strict";
    angular.module("Controllers").controller("loginController", ["$scope", "loginFactory", "utilFactory", "reportService", function (e, t, o, n) {
        $(".lang .lang-item").click(function (e) {
            ...
            function a(i) {
                switch (i.code) {
                    case 200:
                        ...
                        break;
                    case 201:
                        e.isScan = !0, n.report(n.ReportType.timing, {timing: {scan: Date.now()}}), t.checkLogin(r).then(a);
                        break;
                    case 408:
            ...
            var i = !1;
            n.report(n.ReportType.timing, {timing: {qrcodeStart: Date.now()}}), setTimeout(function () {
                i || n.report(n.ReportType.picError, {text: "qrcode can not load", src: e.qrcodeUrl})
            }, 3e3), e.qrcodeLoad = function () {
                i = !0, n.report(n.ReportType.timing, {timing: {qrcodeEnd: Date.now()}})
    ...
    angular.module("Controllers").controller("contentChatController", ["$scope", "$timeout", "$state", "$log", "$document", "$compile", "chatFactory", "accountFactory", "contactFactory", "appFactory", "confFactory", "utilFactory", "chatroomFactory", "mmpop", "ngDialog", "preview", "reportService", "mmHttp", "emojiFactory", function (e, t, o, n, r, a, i, c, s, l, u, f, d, g, m, p, h, M, y) {
        ...
        function v(t) {
            for (var o = e.imagesMessagesList, n = 0; n < o.length; n++)if (o[n].msg.MsgId == t.MsgId) {
                o.splice(n, 1);
                break
            }
        }
        ...
        e.delState = !1, e.chatContent = [], e.isShowChatRoomMembers = !1, e.$on("message:add:success", function (t, o) {
            ...
            if (o.MsgType == u.MSGTYPE_IMAGE && e.imageInit(o), o.ToUserName == e.currentUser)for (var n = 0, r = e.chatContent.length; r > n; ++n) {
            ...
            for (var o, n, r = 0; r < e.imagesMessagesList.length; r++)if (o = e.imagesMessagesList[r], o.msg == t) {
                n = r;
                break
            }
            var a = t.MMStatus;
            (void 0 === a || a == u.MSG_SEND_STATUS_SUCC) && p.open({imageList: e.imagesMessagesList, current: n})
        }, e.resendMsg = function (e) {
            i.sendMessage(e)
        }, e.imageInit = function (t, o) {
            for (var n, r, a, i = e.imagesMessagesList, c = !1, r = e.getMsgImg(t.MsgId), s = 0; s < i.length; s++)if (n = i[s], n.msg === t) {
                c = !0, n.url = r, a = s;
                break
            }
            if (!c) {
                ...
                controller: ["$scope", function (o) {
                    t(function () {
                        ...
                        m.open({
                            ...
                            data: {isCreate: !0, initSelectedContacts: [o.currentContact]}
                        }), o.closeThisMmPop()
                    }
                }]
            ...
            var i = angular.element(window), l = 230, f = 360, d = i.width(), p = i.height(), h = t.pageY, C = t.pageX;
            d - t.pageX < l && (C = t.pageX - l), p - t.pageY < f && (h = t.pageY - f), g.open({
                ...
                controller: ["$scope", function (e) {
                    e.contact = a, e.MMDefaultRemark = MM.context("8d521cc"), e.addUserContent = MM.context("5a97440") + y.formatHTMLToSend(c.getUserInfo().NickName), e.isShowSendBox = r || !1, e.chat = function (t) {
                        o.go("chat", {userName: t}), e.closeThisMmPop()
                        ...
                        var o = $(".profile_mini_wrap .J_Text"), n = o.text(), r = n.length;
        ...
        var b = jQuery("#voiceMsgPlayer"), T = function () {
        ...
        e.playVoice = function (e) {
            require.async(["jplayer"], function () {
                ...
                e.MMVoiceUnRead && (e.MMVoiceUnRead = !1), e.MMPlaying = !0, b.jPlayer({
                    ...
                    supplied: "mp3",
                    wmode: "window"
                }), b.jPlayer("stop"), window.MMplayingMsg = e, b.jPlayer("setMedia", {mp3: t}), b.jPlayer("play")
            })
        };
        var E = !1;
        ...
        e.$watchCollection("chatContent", function (e) {
            if (e.length > 0 && e[e.length - 1].FromUserName === c.getUserName())E = !0; else {
            ...
            var n = "<div message-directive ></div>", r = e.$new();
            r.imageInit = function () {
            }, r.message = t;
            var i = a(n)(r);
            $("#prerender").append(i), function (t, o, n, r) {
                setTimeout(function () {
                    function a() {
                    ...
                    if (n.MsgType == u.MSGTYPE_EMOTICON || n.MsgType == u.MSGTYPE_IMAGE || n.MsgType == u.MSGTYPE_VIDEO) {
                        t.$digest();
                        var c = o.find(".content .msg-img"), s = c.height(), l = {};
                        if (console.log("preload!!!!!!!!!!!!!!!!!!!", n, s > 40 || 1 == c[0].complete && !(0 === c[0].naturalWidth) && s > 0, n.ImgHeight), n.ImgHeight)n.MsgType == u.MSGTYPE_EMOTICON ? (l.height = n.ImgHeight * c.width() / n.ImgWidth + "px", l.widht = c.width() + "px") : (l.height = n.ImgHeight, l.width = n.ImgWidth), n.MMImgStyle = l, t.$digest(), r(o.height()), t.$destroy(), o.remove(); else if (s > 40 || 1 == c[0].complete && 0 !== c[0].naturalWidth && s > 0)r(o.height()), t.$destroy(), o.remove(); else {
    ...
    angular.module("Controllers").controller("chatSenderController", ["$rootScope", "$scope", "$http", "$timeout", "ngDialog", "confFactory", "accountFactory", "contactFactory", "chatFactory", "screenShotFactory", "utilFactory", "mmpop", "stateManageService", "emojiFactory", "reportService", function (e, t, o, n, r, a, i, c, s, l, u, f, d, g, m) {
        function p() {
            var e = "undefined" != typeof D.textContent ? D.textContent : D.innerText, t = D.getElementsByTagName("img").length > 0;
        ...
        function C(e) {
            var t, o, n = "";
            if (window.getSelection)t = window.getSelection(), t.rangeCount > 0 && (o = t.getRangeAt(0).cloneRange(), o.collapse(!0), o.setStart(D, 0), n = o.toString().slice(-e)); else if ((t = document.selection) && "Control" != t.type) {
                var r;
        ...
        function v(e, t) {
            ...
            if (t || M(), window.getSelection) {
                ...
                var r;
                if (n.createContextualFragment)r = n.createContextualFragment(e); else {
        ...
        function S(t) {
            ...
            return {
                update: function (t, o) {
                    e.$broadcast("root:uploadImg:success", {src: t, mediaId: o})
                }, close: o.close
            }
        }
        ...
        function E(e, t) {
            angular.extend(e, {onQueued: K, onProgress: K, onSuccess: K, onError: K}, t)
        }
            ...
            require.async(["webuploader"], function (e) {
                ...
                try {
                    Y = e.create({
                        ...
                        m.report(m.ReportType.uploaderError, {text: "WebUploader 出错", type: e})
                    })
                } catch (o) {
                    t.noflash = !0, m.report(m.ReportType.uploaderError, {text: "WebUploader 出错", type: "no_flash"})
                }
            })
        }
        ...
        t.$on("$destroy", function () {
            ...
            l.isSupport() ? l.capture({
                ok: function () {
                    var t = s.createMessage({MsgType: a.MSGTYPE_IMAGE, Type: a.MSGTYPE_IMAGE});
        ...
        t.editAreaKeyup = function (e) {
            ...
            if (o == a.KEYCODE_ENTER) {
                if (e.altKey || e.ctrlKey || e.metaKey || e.shiftKey) {
                    ...
                    if (!u.browser.msie && window.getSelection) {
                        ...
                        do if (!r || r.nodeValue || "BR" == r.tagName)break; while (r = r.nextSibling);
                        r || (n += n)
                    }
            ...
            if (f.close(), !t.editAreaCtn.replace(/<br\/?>/g, "").match(/^\s*$/)) {
                var e = s.createMessage({MsgType: a.MSGTYPE_TEXT, Content: t.editAreaCtn});
        ...
        var Y, B = 10, H = 20, j = {bmp: 1, png: 1, jpeg: 1, jpg: 1, gif: 0}, q = function (e) {
            ...
            onQueued: function () {
                var e = s.createMessage({MsgType: a.MSGTYPE_IMAGE, Type: a.MSGTYPE_IMAGE});
    ...
    angular.module("Controllers").controller("emojiController", ["$rootScope", "$scope", "$timeout", "emojiFactory", "confFactory", "utilFactory", function (e, t, o, n, r, a) {
        o(function () {
            ...
            var o = e.target;
            if ("A" == o.tagName) {
                var r = o.innerText || o.textContent, i = o.getAttribute("type");
                switch (i) {
                    case"qq":
    ...
    angular.module("Controllers").controller("createChatroomController", ["$rootScope", "$scope", "$timeout", "$state", "$log", "$document", "chatFactory", "contactFactory", "appFactory", "chatroomFactory", "confFactory", "mmpop", "ngDialog", "utilFactory", "stateManageService", "accountFactory", function (e, t, o, n, r, a, i, c, s, l, u, f, d, g, m, p) {
        o(function () {
            t.ngDialogData.isCreate && (h = []), t.allContacts = c.pickContacts(["star", "friend"], {
                star: {filterContacts: h},
                friend: {filterContacts: h, isWithoutStar: !0, isWithoutBrand: !0}
        ...
        t.pickConfig = {
            types: ["star", "friend"],
            opt: {star: {}, friend: {isWithoutStar: !0, isWithoutBrand: !0}, all: {filterContacts: h}}
        }, t.add = function () {
            var e = l.getCurrentContact(), o = [];
            ...
            return angular.forEach(t.selectedUsers, function (e, o) {
                ...
                e.BaseResponse && 0 == e.BaseResponse.Ret || -2013 == e.BaseResponse.Ret ? (n.go("chat", {userName: e.ChatRoomName}), console.log("careate chat room success. chatroom userName:", e.ChatRoomName)) : d.openConfirm({
                    className: "default ",
                    templateUrl: "comfirmTips.html",
                    controller: ["$scope", function (t) {
    ...
    angular.module("Controllers").controller("contextMenuController", ["$rootScope", "$scope", "$state", "contextMenuFactory", "accountFactory", "confFactory", "contactFactory", "ngDialog", "chatroomFactory", "emojiFactory", "utilFactory", "chatFactory", function (e, t, o, n, r, a, i, c, s, l, u, f) {
        function d(e) {
            ...
            for (var n = [e.target], r = e.path || e.originalEvent.path || o(e.target), a = 0, i = r.length; i > a; a++) {
                ...
                if (c) {
                    ...
                    var s = angular.element(document.getElementById("contextMenu")), l = angular.element(window), u = s.width(), f = s.height(), d = l.width(), M = l.height();
                    d - e.pageX < u && (t.contextStyle = {
                        top: e.pageY,
                        left: e.pageX - u
                    }), M - e.pageY < f && (t.contextStyle = {top: e.pageY - f, left: e.pageX - u});
                    break
                }
            }
        }
        ...
        function g(o) {
            ...
            (n.isRoomContact() || n.isContact()) && t.contextMenuList.push(n.isTop() ? {
                ...
                content: MM.context("3d43ff1"), callback: function () {
                    i.setTopContact(o, !0)
                }
            }), n.isRoomContact() && t.contextMenuList.push({
                content: MM.context("1f9be6d"), callback: function () {
                    c.open({
                ...
                content: MM.context("685739c"), callback: function () {
        ...
        function m(o) {
            t.contextMenuList = [{
                content: MM.context("91382d9"), callback: function () {
        ...
        function p(n, r, a) {
            var i = [{
                content: MM.context("7068541"), callback: function () {
                    e.$broadcast("root:profile", {userName: r, event: n})
                }
            }];
            i.push("true" == a ? {
                content: MM.context("b5f1591"), callback: function () {
                    o.go("chat", {userName: r})
                }
            } : {
                content: MM.context("0bd10a8"), callback: function () {
                    e.$broadcast("root:profile", {userName: r, isAdd: !0, event: n})
                }
            }), t.contextMenuList = i
        }
        ...
        function h(o, n, s, l, d) {
            function g(e) {
                ...
                if (t = angular.element(t), t.hasClass("js_message_bubble") || (t = t.parents(".js_message_bubble")), t = t.find(".js_message_plain"), t.length) {
                    var o = t.html().replace(new RegExp("<(?!br|" + a.EMOTICON_REG + ").*?>", "g"), ""), n = u.htmlDecode(o);
                    return n
                }
                return ""
            }
            ...
            var p = m.MMDigest, h = i.getContact(o), M = i.getContact(m.FromUserName);
            ...
            switch (+n) {
                case a.MSGTYPE_TEXT:
                    ...
                    p = y ? y + ":" + m.MMActualContent : m.MMActualContent, p = p.replace(":", ": "), t.contextMenuList.push({
                        ...
                        isCopy: !0, content: MM.context("79d3abe"), callback: function () {
    ...
    angular.module("Controllers").controller("editAreaContactListController", ["$scope", "confFactory", "utilFactory", "$timeout", function (e, t, o) {
        ...
        function r(e) {
            var t = l + u, o = e * t, n = i.scrollTop;
            if (n > o)return void(i.scrollTop = o);
            var r = o + t + u - i.offsetHeight;
            r > n && (i.scrollTop = r)
        }

        var a = document.getElementById("editArea"), i = document.getElementById("editAreaContactPanel"), c = document.getElementById("caretPosHelper"), s = e.memberList.length - 1, l = 42, u = 10;
    ...
    angular.module("Controllers").controller("readMenuController", ["$rootScope", "$scope", "subscribeMsgService", function (e, t, o) {
        t.copyCallback = function () {
            ...
            var e = o.current.Url, n = window.open(e, "_blank");
    ...
    angular.module("Controllers").controller("transpondDialogController", ["$rootScope", "$scope", "$timeout", "$state", "$log", "$document", "chatFactory", "contactFactory", "appFactory", "chatroomFactory", "confFactory", "mmpop", "ngDialog", "utilFactory", "stateManageService", "accountFactory", function (e, t, o, n, r, a, i, c, s, l, u, f, d, g, m, p) {
        ...
        y.unshift({text: MM.context("b3b6735"), type: "header"}), t.initList = y, t.ensure = function () {
    ...
    angular.module("Services").factory("appFactory", ["$http", "$q", "confFactory", "accountFactory", "loginFactory", "utilFactory", "reportService", "mmHttp", function (e, t, o, n, r, a, i, c) {
        var s = {
            globalData: {chatList: []}, init: function () {
                ...
                var e = t.defer(), c = this, s = o.API_synccheck + "?" + ["r=" + a.now(), "skey=" + encodeURIComponent(n.getSkey()), "sid=" + encodeURIComponent(n.getSid()), "uin=" + n.getUin(), "deviceid=" + n.getDeviceID(), "synckey=" + encodeURIComponent(n.getFormateSyncKey())].join("&");
    ...
    angular.module("Services").factory("chatFactory", ["$rootScope", "$timeout", "$http", "$q", "contactFactory", "accountFactory", "emojiFactory", "confFactory", "notificationFactory", "utilFactory", "reportService", "mmHttp", "titleRemind", function ($rootScope, $timeout, $http, $q, contactFactory, accountFactory, emojiFactory, confFactory, notificationFactory, utilFactory, reportService, mmHttp, titleRemind) {
        ...
        var _chatList = [], _chatListInfos = [], _chatMessages = window._chatContent = {}, _currentUserName = "", _addedMsgIdsMap = {}, _msgMap = {}, service = {
            setCurrentUserName: function (e) {
                ...
                data.FromUserName = msg.FromUserName, data.ToUserName = msg.ToUserName, data.LocalID = msg.LocalID, data.ClientMsgId = msg.ClientMsgId, data = angular.extend(accountFactory.getBaseRequest(), {Msg: data}), utilFactory.browser.msie && parseInt(utilFactory.browser.version) < 9 && url == confFactory.API_webwxsendmsg && (data = eval("'" + JSON.stringify(data) + "'")), mmHttp({
                    method: "POST",
                    url: url,
                    data: data,
                    MMRetry: {serial: !0}
                ...
                var t = {Type: confFactory.MSGTYPE_IMAGE, MediaId: e.MediaId};
                ...
                var t = this, o = e.split(",");
                angular.forEach(o, function (e) {
                    if (e && !utilFactory.isShieldUser(e) && !utilFactory.isSpUser(e)) {
                        var t = _chatList.indexOf(e);
                        -1 == t && (_chatList.push(e), utilFactory.isRoomContact(e) && contactFactory.addBatchgetChatroomContact(e))
                    }
                }), t.getChatList()
                ...
                e && (angular.isArray(e) || (e = [e]), angular.forEach(e, function (e) {
                    var t = "", o = 0;
                    if (t = e.UserName ? e.UserName : e.FromUserName == accountFactory.getUserInfo().UserName ? e.ToUserName : e.FromUserName, o = _chatList.indexOf(t), -1 == o)_chatList.unshift(t), utilFactory.isRoomContact(t) && contactFactory.addBatchgetChatroomContact(t); else {
                ...
                var t = this, o = t.getChatMessage(e);
                return o.length ? o[o.length - 1] : {}
            }, addChatMessage: function (e) {
                if (e) {
                    var t = this, o = (e.FromUserName, e.ToUserName, _chatMessages[e.MMPeerUserName] || (_chatMessages[e.MMPeerUserName] = []));
                ...
                var t, o = 0;
                if (t = _chatMessages[e])for (var n = t.length - 1; n >= 0; n--)t[n].MMUnread && ++o;
                return o
                ...
                var t = this, o = contactFactory.getContact(e.FromUserName, "", !0);
                ...
                var t = this;
                if (e.HasProductId)e.MMActualContent = e.MMIsSend ? "" + MM.context("80f56fb") : MM.context("2242ac7") + "", t._textMsgProcess(e); else {
                ...
                var t = this, o = MM.context("0e23719") + e.FileName;
                t._appUrlMsgProcess(e, o)
            }, _appVideoMsgProcess: function (e) {
                var t = this, o = MM.context("4078104") + e.FileName;
                t._appUrlMsgProcess(e, o)
            }, _appOpenMsgProcess: function (e) {
                var t = this, o = MM.context("4f20785");
                ...
                var t = "";
                if (e.FromUserName == accountFactory.getUserName())t = "[" + MM.context("8e94ca5") + "]"; else {
                ...
                } else t = n._findMessageByMsgId(c, a.msgid);
                if (t > -1) {
                    var l = c[t];
                    if (l.MMIsSend)o = MM.context("df1fd91"); else {
                ...
                if (t)for (var o, n, r = 0, a = t.length; a > r; ++r)o = /&lt;a href=(?:'|")(.*?)(?:'|").*?&gt;.*?&lt;\/a&gt;/.exec(t[r]), o && o[1] && (n = o[1], e.MMActualContent = e.MMActualContent.replace(/&lt;a href=(?:'|")weixin:\/\/.*?&lt;\/a&gt;/, ""));
                ...
                function t() {
                    ...
                    var u = notificationFactory.createNotification(utilFactory.clearHtmlStr(o), {body: i, icon: n});
                ...
                for (var o = 0; o < e.length; ++o)if (e[o].MsgId == t)return o;
                return -1
    ...
    angular.module("Services").factory("chatroomFactory", ["$rootScope", "$timeout", "$http", "$q", "contactFactory", "accountFactory", "emojiFactory", "confFactory", "utilFactory", "reportService", "mmHttp", function (e, t, o, n, r, a, i, c, s, l) {
        var u, f = {}, d = {
            setCurrentContact: function (e) {
                ...
                var t = n.defer(), r = angular.extend({
                ...
                n.MemberList.length + t.split(",").length >= 40 ? (console.log("invite", n.MemberList.length + t.split(",").length), this._update("invitemember", e, {inviteMembers: t}, o)) : this._update("addmember", e, {addMembers: t}, o)
            }, delMember: function (e, t) {
                this._update("delmember", e, {delMember: t}), r.getContact(e)
            }, quit: function (e) {
                ...
                var s = angular.extend({
                    ...
                    NewTopic: n.topic,
                    ChatRoomName: t
                }, a.getBaseRequest()), u = c.API_webwxupdatechatroom + "?fun=" + e;
                o({method: "POST", url: u, data: s}).success(function (o) {
                    ...
                    l.report(l.ReportType.netError, {text: "update classroom net error", url: u, params: s})
                })
            }
        };
        return d
    ...
    angular.module("Services").factory("accountFactory", ["$q", "confFactory", "utilFactory", function (e, t, o) {
        var n, r, a, i = {}, c = null, s = {
            ...
            openNotify: function () {
                ...
                var t = parseInt(e, 10).toString(16), o = t.substr(0, 1), t = t.substr(1, 3).replace("0", ".");
                s.type = o, s.ver = t
            }
        };
    ...
    angular.module("Services").factory("confFactory", ["$q", function () {
        var e = location.host, t = "weixin.qq.com", o = "file.wx.qq.com", n = "webpush.weixin.qq.com";
    ...
    angular.module("Services").factory("contactFactory", ["$rootScope", "$http", "$q", "$timeout", "confFactory", "accountFactory", "emojiFactory", "utilFactory", "resourceService", "reportService", "mmHttp", function (e, t, o, n, r, a, i, c, s, l, u) {
        ...
        var d, g = window._contacts = {}, m = window._strangerContacts = {}, p = [], h = [], M = [], y = [], C = window._chatRoomMemberDisplayNames = {}, v = [], w = [], S = [], b = {}, T = {}, E = 0, N = ["fmessage"], P = {
            isSelf: function () {
                ...
                var t = this, o = "";
                if (c.isRoomContact(t.UserName))if (o = t.RemarkName || t.NickName, !o && t.MemberList)for (var n = 0, r = t.MemberList.length; r > n && 10 > n; ++n) {
                    o.length > 0 && (o += ", ");
                    var a = t.MemberList[n], i = A.getContact(a.UserName);
                    o += i && i.RemarkName || i && i.NickName || a.NickName
                } else o || (o = t.UserName); else o = t.RemarkName || e && e != t.UserName && t.getMemberDisplayName(e) || t.NickName;
                return o
                ...
                if (this.isRoomContact()) {
                    ...
                    for (var t = 0, o = this.MemberList.length; o > t; t++) {
                        var n = this.MemberList[t].UserName, r = A.getContact(n);
                ...
                if (!e)return !0;
                e = e.toUpperCase();
                var t = this.RemarkName || "", o = this.RemarkPYQuanPin || "", n = this.NickName || "", r = this.PYQuanPin || "", a = this.Alias || "", i = this.KeyWord || "", c = 0, s = 0;
            ...
            contactChangeFlag: "", setCurrentContact: function (e) {
                ...
                return t({
                    ...
                    params: {skey: a.getSkey(), pass_ticket: a.getPassticket(), seq: e, r: c.now()}
                }).success(function (e) {
                    n.resolve(e)
                }).error(function (e) {
                    n.reject("error:" + e), l.report(l.ReportType.netError, {
                        text: "init contact",
                        url: r.API_webwxgetcontact,
                        params: {skey: a.getSkey(), pass_ticket: a.getPassticket()}
                    })
                }), n.promise
                ...
                for (var t = 0, o = S.length; o > t; t++)if (S[t].UserName == e.UserName)return t;
                return -1
            }, inContactsToGetList: function (e) {
                for (var t = 0, o = v.length; o > t; t++)if (v[t].UserName == e.UserName)return t;
                return -1
            }, inContactsGettingList: function (e) {
                for (var t = 0, o = w.length; o > t; t++)if (w[t].UserName == e.UserName)return t;
                return -1
                ...
                function i(e) {
                    f.resolve(e.ContactList), E = 0, console.time("addContactsHandler"), angular.forEach(e.ContactList, function (e) {
                        var t = d.inContactsToGetList({UserName: e.UserName});
                        t > -1 && v.splice(t, 1), c.isRoomContact(e.UserName) && e.MemberList && e.MemberList.length ? angular.forEach(e.MemberList, function (t) {
                            ...
                            var n = d.inContactsToGetList({UserName: t.UserName});
                            n > -1 && v.splice(n, 1)
                ...
                for (var o in g)if (!e.filterContacts[o]) {
                    var n = g[o];
                ...
                return this.prevSearchCanceler && this.prevSearchCanceler.resolve(), this.prevSearchCanceler = o.defer(), T[e] ? i.resolve(n(T[e])) : t({
                    ...
                    data: angular.extend(a.getBaseRequest(), {KeyWord: e})
                }).success(function (t) {
                ...
                for (var n, r, a, i = [], c = this, s = t.all || {}, l = 0; l < e.length; l++)switch (n = e[l], a = t[n] || {}, a = $.extend({}, a, s), n) {
                    ...
                    case"friend":
                        if (r = c.getAllFriendContact(a), r.length > 0) {
                            a.showFriendHeader && i.push({text: MM.context("59d29a3"), type: "header"});
                            var u = "";
                            a.showFriendHeader || a.noHeader || angular.forEach(r, function (e, t) {
                                if (e.MMOrderSymbol) {
                                    var o = e.MMOrderSymbol.charAt(0);
                                    u != o && (u = o, r.splice(t, 0, {text: o, type: "header"}))
                                }
                            }), [].push.apply(i, r)
                        }
                        break;
                ...
                return o && (i = angular.copy(i)), {result: i}
    ...
    "use strict";
    angular.module("Services").factory("loginFactory", ["$http", "$q", "$timeout", "accountFactory", "confFactory", "utilFactory", "mmHttp", "reportService", function (e, t, o, n, r, a, i, c) {
        var s = {
            getUUID: function () {
                var e = t.defer();
                return window.QRLogin = {}, $.ajax({url: r.API_jsLogin, dataType: "script"}).done(function () {
                ...
                return i({
                    ...
                    c.report(c.ReportType.timing, {timing: {loginEnd: Date.now()}}), o.resolve(e)
                }).error(function (e) {
                    o.reject("error:" + e)
                }), o.promise
            }, loginout: function (e) {
                ...
                a.form(t, {sid: n.getSid(), uin: n.getUin()})
        ...
        var u = {
            ...
            clearCookie: function () {
                for (var e = document.cookie.split(";"), t = 0; t < e.length; t++) {
                    var o = e[t], n = o.indexOf("="), r = n > -1 ? o.substr(0, n) : o;
            ...
            hrefEncode: function (e) {
                var t = this, o = e.match(/&lt;a href=(?:'|").*?(?:'|").*?&gt;.*?&lt;\/a&gt;/g);
                if (o) {
            ...
            formatNum: function (e, t) {
                var o = (isNaN(e) ? 0 : e).toString(), n = t - o.length;
            ...
            initMsgNoticePlayer: function (e) {
                ...
                require.async(["jplayer"], function () {
                    t.jPlayer({
                        ...
                        supplied: "mp3",
                        wmode: "window"
                    }), t.jPlayer("stop"), t.jPlayer("setMedia", {mp3: e}), t.jPlayer("play")
                })
            },
            ...
            queryParser: function () {
                for (var e = {}, t = location.search.substring(1), o = t.split("&"), n = 0, r = o.length; r > n; n++) {
                    var a = o[n].split("="), i = decodeURIComponent(a[0]);
            ...
            getSize: function (e) {
                if (e = +e) {
                    var t = 10, o = 10, n = 20, r = 1 << o, a = 1 << n;
                    if (e >> n > 0) {
    ...
    angular.module("Services").factory("screenShotFactory", ["confFactory", "reportService", function (e, t) {
        ...
        var c = "screencapture", s = "uploader", l = null, u = null;
        return {
            isSupport: function () {
    ...
    angular.module("Services").factory("notificationFactory", ["utilFactory", function (e) {
        ...
        var s = "default", l = "granted", u = "denied", f = [l, s, u], d = {
            pageVisibility: !1,
            autoClose: 5e3,
            total: 3
        }, g = "", m = function () {
            ...
            return t
        }(), p = Math.floor(10 * Math.random() + 1), h = [], M = d, y = {
    ...
    angular.module("Services").factory("resourceService", ["$timeout", "$http", "$q", "$window", function (e, t, o, n) {
        function r(t, o, n) {
            ...
            for (var r, i = o.priority ? c : s, u = l.push({
                    callback: n || function () {
                    }, taskNum: t.length, combo: o.combo, result: {}
    ...
    angular.module("Services").factory("stateManageService", ["$http", "$q", function () {
        function e(e) {
            if ("object" == typeof e)for (var n in e)o[n] !== e[n] && t(n, e[n]), o[n] = e[n]
        }

        function t(e, t) {
            var o = n[e];
            if (o)for (var r = 0; r < o.length; r++)o[r](t)
        }
        ...
        var o = {
            ...
            change: function (n, a) {
                ...
                var o, r = n[e];
                if (r)for (var a = 0; a < r.length; a++)if (o = r[a], o == t)return void r.splice(a, 1)
            }, data: function (e, t) {
    ...
    angular.module("Services").factory("reportService", ["$http", "$rootScope", "confFactory", "accountFactory", function (e, t, o, n) {
        ...
        function a(e) {
            e.needSend ? (p({
                Type: 1,
                Text: JSON.stringify({type: T.timing, data: r()})
            }, !0), P = !0, f()) : e.fullTiming ? p({
                Type: 1,
                Text: JSON.stringify({type: T.timing, data: e.fullTiming})
            }, !0) : $.extend(N, e.timing)
        }
        ...
        function s(e, t) {
            ...
            var r = JSON.stringify({type: e, data: n});
            return r
        }
        ...
        function u(e, t, o) {
            ...
            var n, r = o || !1;
            e.indexOf("-error") > 0 ? (r = !0, n = {Type: 2, Text: s(e, t)}) : n = {Type: 1, Text: s(e, t)}, p(n, r)
        }
        ...
        function d() {
            $(window).unload(function () {
                w.unload = m(t), v.push({type: T.runtime, data: w}), !P && v.push({
                    type: T.timing,
                    data: {fullTiming: r()}
        ...
        function M(t) {
            e({
                ...
                data: {BaseRequest: {Uin: n.getUin(), Sid: n.getSid()}, Count: t.length, List: t}
            }).success(function (e) {
                console.log(e)
            }).error(function (e) {
                console.log(e)
    ...
    angular.module("Services").factory("mmHttp", ["$http", "$q", "$timeout", function (e, t, o) {
        function n(n) {
            ...
            var l = n.data, u = n.config, f = u.MMRetry, d = "undefined" == typeof f.count ? 3 : f.count, g = f.timeout || 15e3, m = f.serial, p = [], h = [], M = 0, y = t.defer(), C = 0;
        ...
        for (var r, a = function (e) {
            var t = e.method ? e.method.toLowerCase() : "get", o = e.url, n = e.data, r = [o];
            ...
            return function (o) {
                ...
                var s;
                return s = c ? n({args: i, method: t, config: a, data: {complete: !1}}) : e[t].apply(e, i)
            }
        }(r);
        return a
    }])
    ...
    angular.module("Services").factory("titleRemind", ["$window", function (e) {
        ...
        var o = !0, n = e.document, r = {
            defaultTitle: MM.context("2f521c5"), unreadMsgNum: 0, start: function () {
                var e = this;
        ...
        var a = [], i = {
            current: null, changeFlag: 0, init: function (e) {
                ...
                for (var t = 0, n = e.length; n > t; t++) {
                    var i = e[t];
                    i.HeadImgUrl = i.HeadImgUrl = r.getContactHeadImgUrl({UserName: i.UserName, Skey: o.getSkey()});
    ...
    angular.module("Directives").directive("messageDirective", ["$timeout", "confFactory", function () {
        return {
            restrict: "A", templateUrl: "message.html", link: function () {
            }
        }
    }])
    ...
    return function (t, o, n) {
        ...
        o.bind("input propertychange", function (e) {
            t.$$phase ? r(t, {$event: e}) : t.$apply(function () {
                r(t, {$event: e})
            })
        })
    }
    ...
    return {
        restrict: "EA", scope: {}, link: function () {
        }
    }
}]).provider("mmpop", function () {
    var e = angular.element, t = (angular.isDefined, (document.body || document.documentElement).style, this.defaults = {
        className: "",
        plain: !1,
        showClose: !0,
        closeByEscape: !0,
    ...
    this.$get = ["$document", "$templateCache", "$compile", "$q", "$http", "$rootScope", "$timeout", "$window", "$controller", "$animate", function (a, i, c, s, l, u, f, d, g, m) {
        var p = a.find("body"), h = {
            onDocumentKeydown: function (e) {
                ...
                }), r[o] && (r[o].resolve({id: o, value: t, $pop: e, remainingPops: n}), delete r[o]))
            }, closePop: function (e, t) {
                h.performClosePop(e, t)
            }
        }, M = {
            open: function (l) {
                var d = this, y = angular.copy(t);
    ...
    return {
        restrict: "A", require: "?ngModel", link: function (e, n, r, a) {
            function i(e) {
                ...
                n.bind("paste", function () {
                    ...
                    s && clearTimeout(s), s = setTimeout(function () {
                        ...
                        if (-1 != l && -1 != u) {
                            ...
                            var m = c.substring(l, u + 1), p = c.substr(0, l), h = c.substr(l + m.length), M = p.lastIndexOf("<"), y = p.lastIndexOf(">");
    ...
    angular.module("Directives").directive("miniUserProfileDirective", ["$timeout", "confFactory", function () {
        ...
        return {
            restrict: "A", scope: {user: "="}, templateUrl: "userProfile.html", link: function () {
            }
        }
    }])
}(), !function () {
                ...
                function i() {
                    require.async(["jplayer"], function () {
                        jQuery(r).jPlayer({
                            ...
                            loop: a.loop !== e,
                            size: {width: n.width || "200px", height: n.height || "150px", cssClass: "jp-video-360p"}
    ...
    return {
        restrict: "EA", templateUrl: "preview.html", scope: {imageList: "=", current: "="}, link: function (n, r) {
            function a(e) {
                switch (e.keyCode) {
                    case t.KEYCODE_ARROW_UP:
            ...
            function c(e) {
                var t, o;
                if (e.scale)t = e.scale, o = {x: .5, y: .5}; else {
                    var n = e.delta;
                    o = e.posRatio || {x: .5, y: .5}, t = y.scale, t = n > 0 ? t + S : t - S
                }
                t = t > w ? w : 1 / w > t ? 1 / w : t;
                var r = {width: Math.round(M.width * t), height: Math.round(M.height * t), scale: t};
            ...
            function u() {
                d.on("mousedown", function (e) {
                    return N ? void n.actions.close() : (C = {x: e.clientX, y: e.clientY}, v = {
                        top: y.top,
                        left: y.left
                    ...
                    ("mousewheel" == o.type || "DOMMouseScroll" == o.type) && (t = o.wheelDelta ? o.wheelDelta / 120 : -(o.detail || 0) / 3), void 0 !== t && (c(N ? {delta: t} : {
                        delta: t,
                        posRatio: {x: o.offsetX / y.width, y: o.offsetY / y.height}
                    }), e.preventDefault(), e.stopPropagation())
                }), e.keydown(i)
            }
            ...
            function f() {
                ...
                var t = new Image;
                t.onload = function () {
                    t.onload = null, M = {width: t.width, height: t.height}, y = {
                        width: M.width,
                        height: M.height,
                        top: (h - M.height) / 2,
                        left: (p - M.width) / 2,
                    ...
                    var e = T / t.height, o = b / t.width;
                    1 > e && 1 > o ? c({scale: o > e ? e : o}) : 1 > e ? c({scale: e}) : 1 > o ? c({scale: o}) : d.css(y), angular.extend(E, y), m[0].src = t.src, n.isLoaded = !0, n.containerStyle = null, n.$digest()
                }, t.onerror = function () {
                    t.onerror = null, alert(MM.context("845ec73"))
                }, t.src = n.imageList[n.current].url
            }

            var d = r.find("#img_dom"), g = r.find("#img_opr_container"), m = d.find("#img_preview"), p = document.documentElement.clientWidth, h = document.documentElement.clientHeight - parseInt(g.css("bottom")) - parseInt(g.height());
            n.isLoaded = !1, n.rotateDeg = 0, n.isIE = !!(o.browser.msie && o.version < 10), n.actions = {
                next: function () {
                    ...
                    n.rotateDeg = (n.rotateDeg + 90) % 360, c({scale: E.scale}), s({
                        top: (h - y.height) / 2,
                        left: (p - y.width) / 2
        ...
        $get: ["$rootScope", "$document", "$compile", function (e, t, o) {
            var n = {
                open: function (r) {
                    ...
                    var i;
                    i = e.$new(), angular.extend(i, {imageList: r.imageList, current: r.current});
                    var c = angular.element('<div preview-directive class="J_Preview" current="current" image-list="imageList"></div>'), s = o(c)(i), l = t.find("body").eq(0);
                    l.append(s);
                    var u = {
                        close: function () {
                            var e = s.scope();
    ...
    return {
        restrict: "A", link: function (e, t) {
            var o = "scrollLazyload", n = function () {
                $("img.lazy").lazyload({container: t, event: o})
            };
            n()
        }
    }
    ...
    return {
        restrict: "A", link: function (t, o) {
            var n, r = "scrollLazyload", a = function () {
                $("img.lazy").lazyload({container: o, event: r})
            }, i = 0, c = 0, s = function () {
    ...
    return {
        link: function (e, t) {
            setTimeout(function () {
                t.scrollbar({
                    test: "test", type: "simpble", onScroll: function (t, o) {
                        e.$broadcast("onScroll", {y: t, x: o})
                    }, onUpdate: function () {
    ...
    "use strict";
    var t = e.module("ngDialog", []), o = e.element, n = e.isDefined, r = (document.body || document.documentElement).style, a = n(r.animation) || n(r.WebkitAnimation) || n(r.MozAnimation) || n(r.MsAnimation) || n(r.OAnimation), i = "animationend webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend", c = !1;
    t.provider("ngDialog", function () {
        ...
        this.$get = ["$document", "$templateCache", "$compile", "$q", "$http", "$rootScope", "$timeout", "$window", "$controller", function (u, f, d, g, m, p, h, M, y) {
            ...
            var _ = {
                ...
                open: function (a) {
                    ...
                    function c(t) {
                        return t ? e.isString(t) && w.plain ? t : "boolean" != typeof w.cache || w.cache ? f.get(t) || i(t, {cache: !0}) : i(t, {cache: !1}) : "Empty template"
                    }

                    var u = this, w = e.copy(t);
                    ...
                    return g.when(c(w.template || w.templateUrl)).then(function (t) {
                        ...
                        if (w.controller && (e.isString(w.controller) || e.isArray(w.controller) || e.isFunction(w.controller))) {
                            var i = y(w.controller, {$scope: E, $element: b});
                        ...
                        if (E.closeThisDialog = function (e) {
                                ...
                                var t = w.closeByDocument ? o(e.target).hasClass("ngdialog-overlay") : !1, n = o(e.target).hasClass("ngdialog-close");
                        ...
                        id: "ngdialog" + r, closePromise: S.promise, close: function (e) {
                            _.closeDialog(b, e)
                        }
                    }
                }, openConfirm: function (t) {
                    var n = g.defer(), r = {closeByEscape: !1, closeByDocument: !1};
        ...
        return {
            restrict: "A", scope: {ngDialogScope: "="}, link: function (o, n, r) {
    ...
    function o(e, t, o, n, r) {
        ...
        if (o > n) {
            for (var s = t; s > -1; s--)if (a = e[s], i = c, c += a._h || (a._h = r(a)), n > o - c)return {
                index: s,
                total: i
            };
            return {index: 0, total: 0}
        }
        for (var s = t; s < e.length; s++)if (a = e[s], i = c, c += a._h || (a._h = r(a)), o + c > n)return {
            index: s,
            total: i
        };
    ...
    function i(e) {
        if (!(e.length <= 0))for (var t, o = 0, n = 0; n < e.length; n++)t = e[n], t._offsetTop = o, o += t._h
    }

    function c(e, t, o) {
        if (!(e.length <= 0))for (var n, r = 0; r < e.length; r++)n = e[r], (!n._h || o) && (n._h = t(n))
    }
    ...
    return {
        restrict: "EA", priority: 1e3, scope: !0, terminal: !0, link: function (e, o, n) {
            var r = [], u = {
                maxScroll: 0,
                scroll: 0,
                size: 0,
                visible: 687
            }, f = n.mmRepeat.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?\s*$/), d = f[2], g = (f[1], '<div ng-style="{height:topHeight}" class="top-placeholder"></div><div ng-repeat="' + n.mmRepeat + '">' + o.html() + '</div><div ng-style="{height:bottomHeight}" class="bottom-placeholder"></div>'), m = t(g)(e);
            o.html(""), o.append(m), e.bufferHeight || (e.bufferHeight = 100), e.preCalc = n.preCalc && "false" !== n.preCalc ? !0 : !1, e[d] = [], e.$on("onScroll", function (t, o) {
                ...
                if (t instanceof Array)if (r = t, t.length > 0) {
    ...
    return {
        restrict: "A", priority: 1001, scope: !1, link: function (e, n, r) {
            function a(t) {
                e.$emit("mmrepeat:select", t)
            }

            function i(e, t, o) {
                var n = t._h, r = t._offsetTop, a = e.scrollTop;
            ...
            var s = r.mmRepeat.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?\s*$/), l = s[2];
            e.$parent.$watch(l, function (e) {
                e && (u = e)
            });
            var u = e.$parent[l], f = r.mmRepeatKeyboardScrollSelector, d = $(f)[0];
    ...
    return {
        restrict: "A", link: function (e, t) {
            function o(e) {
                var t = n[e];
                if (t) {
                    var o = t._h, a = t._offsetTop, i = r.scrollTop;
            ...
            var n = e.allContacts, r = t[0], a = n.length && n[0].type && "header" == n[0].type ? 1 : 0;
            n.length - 1, e.selectIndex = a, e.$on("root:searchList:keyArrowUp", function () {
                var t = e.selectIndex;
                do--t; while (t > a && "header" == n[t].type);
                t = a > t ? a : t, e.selectIndex = t, o(t)
            }), e.$on("root:searchList:keyArrowDown", function () {
                var t = n.length - 1, r = e.selectIndex;
                do++r; while (t > r && "header" == n[r].type);
    ...
    return {
        restrict: "EA", scope: !0, templateUrl: "navChat.html", link: function (t) {
            function o(e) {
            ...
            function n(e, t) {
                for (var o, n = 0; n < e.length; n++)if (o = e[n], o.UserName === t)return o
            }

            function i(e, t) {
                var o = t._h, n = t._offsetTop, r = e.scrollTop;
    ...
    return {
        restrict: "EA", scope: !0, templateUrl: "navContact.html", link: function (c) {
            function s(t) {
                if (r.canDo("navKeydown")) {
                    var o = c.allContacts, n = c.currentContact || o[0], s = n;
                    i.wait(function () {
    ...
    return {
        restrict: "EA", scope: !0, templateUrl: "navRead.html", link: function (e) {
    ...
    return {
        restrict: "EA", scope: {pasteLimit: "=", pasteResetTime: "="}, link: function (n, r) {
            ...
            t.contactList = r(c.pickContacts(p.types, p.opt, !0).result, h), t.selectList = t.selectList || [], i(), t.search = function () {
                g && e.cancel(g), g = e(function () {
                    if (t.keyword) {
                        ...
                        var e = $.extend(d(t.selectList), p.opt.all.filterContacts), o = $.extend({}, p.opt, {
    ...
    var o = $(window), n = o.height(), r = o.width();
    return o.on("resize", function () {
        t.fitRun("resize", function () {
            var t = o.height(), a = o.width(), i = [], c = "height-" + (n > t ? "smaller" : "bigger"), s = "width-" + (r > a ? "smaller" : "bigger");
        ...
        priority: 99, scope: {types: "=trackType", opt: "=trackOpt"}, link: function (t, o) {
            var n = t.opt, r = t.types;
            for (var a in r) {
                var i = r[a];
                if ("keydown" == i) {
                    var c = n.keys, s = {enter: 13, backspace: 8, blankspace: 32};
                ...
                if ("click" == i) {
                    ...
                    o.on("click", function (t) {
                        l && t.timeStamp - l <= 30 || (l = t.timeStamp, e.addRecord({type: "click", action: n.target}))
                    })
                }
                "focus" == i && o.on("focus", function () {
                    e.addRecord({type: "focus", action: n.target})
                })
            }
        }
    }
    ...
    var t = 100, o = [], n = {
        report: function () {
            o.length > 0 && e.report(e.ReportType.actionRecord, {actions: o}, !0), o = []
    ...
    t.module("ngClipboard", []).provider("ngClip", function () {
        ...
        var a = {swfPath: n.path, trustedDomains: ["*"], allowScriptAccess: "always", forceHandCursor: !0};
        e.ZeroClipboard ? r() : o.$on("root:pageInit:success", function () {
            r()
        })
    }]).directive("clipCopy", ["ngClip", function () {
        return {
            scope: {clipCopy: "&", clipClick: "&", clipClickFallback: "&"},
            restrict: "A",
            link: function (e, o, n) {
    ...
    "use strict";
    angular.module("Filters").filter("HTMLEnCode", function () {
        ...
        return function (t) {
            var t = 1e3 * t, o = new Date, n = o.getTime() / 1e3, r = o.getDay();
            o.setTime(t);
    ...
    "use strict";
    function e(e, t) {
        var o = (65535 & e) + (65535 & t), n = (e >> 16) + (t >> 16) + (o >> 16);
        return n << 16 | 65535 & o
    }
    ...
    angular.module("webwxApp", ["ui.router", "ngAnimate", "Services", "Controllers", "Directives", "Filters", "ngDialog", "jQueryScrollbar", "ngClipboard", "exceptionOverride"]).run(["$rootScope", "$state", "$stateParams", function (e, t, o) {
        ...
        n.state("chat", {
                ...
                navView: {
                    controller: ["$stateParams", "chatFactory", "contactFactory", "stateManageService", "$rootScope", function (e, t, o, n, r) {
                        function a() {
                            ...
                            r.$broadcast("root:statechange"), t.setCurrentUserName(e.userName), t.addChatList([n || {FromUserName: e.userName}]), e.userName = ""
                        }
            ...
            url: "", views: {
                ...
                }, contentView: {templateUrl: "contentContact.html", controller: "contentContactController"}
            }
        }).state("read", {
            url: "",
            params: {readItem: ""},
                ...
                contentView: {
                    ...
                    controller: ["$scope", "$stateParams", "subscribeMsgService", "mmpop", function (e, t, o, n) {
                        ...
                        e.optionMenu = function () {
                            ...
                            var e = $(this).contents().find("body"), t = e.find("#js_view_source");
                            if (t.length > 0) {
    ...
    var p = angular.bootstrap.toString(), h = m(p);
    "54c6b762ad3618c9ebfd4b439c8d4bda" !== h && $.getScript("https://tajs.qq.com/stats?sId=54802481"), angular.bootstrap(document, ["webwxApp"])
}();